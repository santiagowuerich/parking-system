...
CREATE TABLE public.abonos (
  ...
  CONSTRAINT abonos_pkey PRIMARY KEY (abo_nro, est_id),
...
CREATE TABLE public.disponibilidad_empleado (
  ...
  CONSTRAINT disponibilidad_empleado_pkey PRIMARY KEY (turno_id, play_id, dia_semana),
...
CREATE TABLE public.reservas (
  ...
  res_monto real,
  CONSTRAINT reservas_pkey PRIMARY KEY (veh_patente, est_id, res_fh_ingreso, pla_numero),
...
CREATE TABLE public.tarifas (
  ...
  plantilla_id integer NOT NULL,
  CONSTRAINT tarifas_pkey PRIMARY KEY (tiptar_nro, plantilla_id, est_id, tar_f_desde),
...
CREATE TABLE public.turno_asignados (
  ...
  CONSTRAINT turno_asignados_pkey PRIMARY KEY (play_id, tura_fh_inicio, est_id),
...
CREATE TABLE public.vehiculos_abonados (
  ...
  abo_nro integer NOT NULL,
  veh_patente text NOT NULL,
  CONSTRAINT vehiculos_abonados_pkey PRIMARY KEY (veh_patente, est_id, abo_nro),

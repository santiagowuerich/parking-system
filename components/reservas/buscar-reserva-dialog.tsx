                                                ...
                                                <div className="grid grid-cols-2 gap-4 text-sm">
                                                    ...
                                                    <div>
                                                        <div className="flex items-center gap-1 text-gray-600 mb-1">
                                                            ...
                                                            <span>{dayjs.tz(reserva.res_fh_ingreso, 'America/Argentina/Buenos_Aires').format('HH:mm')}</span>
                                                        </div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <div className="font-medium">
                                                    {format(dayjs.tz(resultado.res_fh_ingreso, 'America/Argentina/Buenos_Aires').toDate(), 'dd/MM/yyyy HH:mm', { locale: es })}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <div className="font-medium">
                                                    {format(dayjs.tz(resultado.res_fh_fin, 'America/Argentina/Buenos_Aires').toDate(), 'dd/MM/yyyy HH:mm', { locale: es })}
                                                </div>
                                            </div>
                                        </div>

            ...
            <div className="container mx-auto p-6 max-w-7xl">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 dark:text-zinc-400">
                        Administra los empleados del sistema de estacionamientos
                    </p>
                </div>
                ...
                <Card className="max-w-2xl mx-auto">
                    ...
                    <CardContent className="text-center space-y-4">
                        <p className="text-gray-600 dark:text-zinc-400">
                            La gestión completa de empleados estará disponible próximamente.
                            Por ahora puedes gestionar los aspectos básicos desde otros paneles.
                        </p>

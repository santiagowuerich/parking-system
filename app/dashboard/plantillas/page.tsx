            ...
            <div className="container mx-auto p-6 max-w-7xl">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 dark:text-zinc-400">
                        Define y gestiona diferentes tipos de plazas de estacionamiento
                    </p>
                </div>
                ...
                <Card className="max-w-2xl mx-auto">
                    ...
                    <CardContent className="text-center space-y-4">
                        <p className="text-gray-600 dark:text-zinc-400">
                            La gestión avanzada de plantillas estará disponible próximamente.
                            Por ahora puedes gestionar las configuraciones básicas desde otros paneles.
                        </p>
